...
#define MyAppURL "leosoft.ddns.net"
#define MyAppExeName "Chatclient.exe"

[Setup]
; NOTE: The value of AppId uniquely identifies this application. Do not use the same AppId value in installers for other applications.
; (To generate a new GUID, click Tools | Generate GUID inside the IDE.)
AppId={{A5B24E2D-1858-48FA-94B4-046AC88E8B1A}
AppName={#MyAppName}
...
OutputDir=C:\Users\Leonard\Desktop\Projekte\Chat
...
[Files]
Source: "C:\Users\Leonard\Desktop\Projekte\Chat\bin\Release-windows-x86\Chatclient\Chatclient.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Leonard\Desktop\Projekte\Chat\bin\Release-windows-x86\Chatserver\Chatserver.exe"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Leonard\Desktop\Projekte\Chat\bin\Release-windows-x86\Chatclient\imgui.ini"; DestDir: "{app}"; Flags: ignoreversion
Source: "C:\Users\Leonard\Downloads\VC_redist.x86.exe"; DestDir: {tmp}; Flags: deleteafterinstall
...
Filename: {cmd}; Parameters: "/C Rmdir ""{app}\Uninstallers\{#MyAppName}"""; Flags: RunHidden WaitUntilTerminated
